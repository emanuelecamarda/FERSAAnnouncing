...
public class ApartmentResearchBoundary {
    ...
    public void newApartmentResearch() {
       try {
            ...
            List<Apartment> apartments = apartmentResearchController.newApartmentResearch(null, cityField.getText(), priceMin, priceMax, size, favoriteCheck.isSelected(), userLogged, sortingField.getValue().toString(), localsMin, localsMax, furnishedCheck.isSelected(), bathrommNumber, bedsNumberMin, bedsNumberMax);
